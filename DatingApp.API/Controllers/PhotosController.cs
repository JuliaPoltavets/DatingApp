...
namespace DatingApp.API.Controllers
{
    ...
    public class PhotosController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetPhoto(int id)
        {
            ...
            //Photo includes all user details as User is navigation property on our Photo
            //So we need to create a Dto for Photo that will excude User details
            ...
            int userId, [FromForm]PhotoForCreationDto photoForCreationDto)
        {
            ...
            //will use to store the result from Cloudinary
